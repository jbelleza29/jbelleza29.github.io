const navItems = [
  { label: "About",      href: "#about",      normal: "/nav/about-normal.png",       active: "/nav/about-active.png" },
  { label: "Projects",   href: "#projects",   normal: "/nav/projects-normal.png",    active: "/nav/projects-active.png" },
  { label: "Experience", href: "#experience", normal: "/nav/experiences-normal.png", active: "/nav/experiences-active.png" },
];
...
export default function NavBar() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-stroke bg-canvas/90 backdrop-blur-md jnav-overflow">
