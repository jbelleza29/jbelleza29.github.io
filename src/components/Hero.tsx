      ...
      <div className="mx-auto max-w-5xl w-full">
        ...
        <div className="flex gap-4 flex-wrap">
          <a
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-lime hover:bg-sage text-canvas font-medium rounded-lg text-sm transition-colors duration-200"
          >
            <GitHubIcon />
            GitHub
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-5 py-2.5 border border-olive hover:border-sage text-sage hover:text-lime font-medium rounded-lg text-sm transition-colors duration-200"
          >
            <LinkedInIcon />
            LinkedIn
          </a>
